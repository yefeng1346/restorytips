  ...
  en: {
    ...
    legal: {
      privacy: {
        ...
        advertising: "Public content pages may load Google AdSense with publisher ID ca-pub-4496419024798372 and a third-party native advertising script from staffresumed.com. Any data processing by those providers is governed by their own policies.",
  ...
  ru: {
    ...
    legal: {
      privacy: {
        ...
        advertising: "На открытых страницах может загружаться Google AdSense с идентификатором издателя ca-pub-4496419024798372 и сторонний нативный рекламный скрипт staffresumed.com. Обработка данных этими провайдерами регулируется их собственными правилами.",
  ...
  de: {
    ...
    legal: {
      privacy: {
        ...
        advertising: "Öffentliche Inhaltsseiten können Google AdSense mit der Publisher-ID ca-pub-4496419024798372 und ein natives Werbeskript von staffresumed.com laden. Die Datenverarbeitung dieser Anbieter richtet sich nach deren eigenen Richtlinien.",
  ...
  ja: {
    ...
    legal: {
      privacy: {
        ...
        advertisingTitle: "広告",
        advertising: "公開コンテンツページでは、パブリッシャーID ca-pub-4496419024798372のGoogle AdSenseと、staffresumed.comのネイティブ広告スクリプトが読み込まれる場合があります。各プロバイダーによるデータ処理は、それぞれのポリシーに従います。",

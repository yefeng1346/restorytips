...
export function GET() {
  ...
  const body = [
    ...
    "",
    "Content status: details that are not verified in the supplied research are marked 待确认 on the relevant page. This site is not affiliated with Mandragora, tinyBuild, or Valve.",
  ].join("\n");
